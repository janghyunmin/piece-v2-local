...
@AndroidEntryPoint
class WithdrawalNextActivity : BaseActivity<ActivityNextWithdrawBinding>(R.layout.activity_next_withdraw){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.number.text = withdrawRequestAmount + "원을 보낼게요"
...
//                    }
        ...
        binding.confirmBtn.setOnClickListener {
            ...
            response?.postDepositWithdraw(
                ...
                deviceId,
                memberId,
                withdrawModel = WithdrawModel(withdrawRequestAmount.replace("[^\\d]".toRegex(), "").toInt())
