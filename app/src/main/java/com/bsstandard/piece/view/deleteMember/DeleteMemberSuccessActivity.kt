...
import com.bsstandard.piece.databinding.ActivityDeletememberSuccessBinding
 ...
 * author         : piecejhm
 * date           : 2022/09/21
 * description    : 탈퇴 성공시 보여지는 Activity
 * ===========================================================
 * DATE              AUTHOR             NOTE
 * -----------------------------------------------------------
...
@AndroidEntryPoint
class DeleteMemberSuccessActivity : BaseActivity<ActivityDeletememberSuccessBinding>(R.layout.activity_deletemember_success){

    val mContext: Context = this@DeleteMemberSuccessActivity
    companion object {
        const val TAG: String = "DeleteMemberSuccessActivity"
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.apply {
            binding.lifecycleOwner = this@DeleteMemberSuccessActivity
