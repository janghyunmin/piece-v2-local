 ...
 * fileName       : NoticeDetailWebView
 * author         : piecejhm
 * date           : 2022/09/11
 * description    : 공지사항 상세 WebView Class
 * ===========================================================
 * DATE              AUTHOR             NOTE
 * -----------------------------------------------------------
...
class NoticeDetailWebView :
    ...
    private lateinit var vm: NoticeDetailViewModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.apply {
            lifecycleOwner = this@NoticeDetailWebView
            binding.noticeDetailWebView = this@NoticeDetailWebView
            binding.noticeDetailViewModel = noticeDetailViewModel

            vm = ViewModelProvider(this@NoticeDetailWebView)[NoticeDetailViewModel::class.java]
    ...
    override fun onStart() {
        super.onStart()
        LogUtil.logE("NoticeDetailWebView onStart..")
    }
