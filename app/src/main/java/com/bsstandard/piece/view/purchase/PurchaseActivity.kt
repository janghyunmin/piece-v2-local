...
class PurchaseActivity : BaseActivity<ActivityPurchaseBinding>(R.layout.activity_purchase),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 남은수량 구하는 계산 질의 필요 - jhm 2022/10/21
        ...
        binding.fTitle.text = totalPieceVolume
        ...
        liveText.observe(this@PurchaseActivity, Observer {
            if (it.isNotEmpty()) {
                ...
                allPrice = it.toInt().times(minPurchaseAmount.toInt()).toString() // 총 주문 금액 - jhm 2022/10/21
            } else {
        ...
        binding.confirmBtn.setOnClickListener {
            if (binding.confirmBtn.isSelected) {
                ...
                bundle.putString("minPurchaseAmount",minPurchaseAmount) // 조각당 금액 단위 - jhm 2022/10/21
