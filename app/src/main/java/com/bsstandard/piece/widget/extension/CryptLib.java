...
public class CryptLib {
    ...
    public String encryptPlainTextWithRandomIV(String plainText, String key, boolean isEncoding) throws Exception {
    ...
    public String decryptCipherTextWithRandomIV(String cipherText, String key, boolean isEncoding) throws Exception {
        cipherText = isEncoding ? URLDecoder.decode(cipherText, "UTF-8") : cipherText;
